...
urlpatterns = [
    ...
    url(r'^autocase_failure/$', views.AutoCaseFailureList.as_view(), name='auto_failure_list'),
    url(r'^autocase_failure/(?P<pk>[a-zA-Z0-9\-\._]+)/$', views.AutoCaseFailureDetail.as_view(), name='auto_failure_detail'),
